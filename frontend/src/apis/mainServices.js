...
const articleUrl  = "http://localhost:9090/api/bears/articles"
const commentUrl = "http://localhost:9090/api/bears/articles" // 이거 2개는 일단 분기...흠
...
export default {
  ...
  putComment(categoryName,articleNo,comment) {
